...
<div class="py-12 bg-gradient-to-b from-green-50 to-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form action="{{ route('leagues.store') }}" method="POST" class="space-y-8">
                @csrf
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name" required
                                   ...
                                   placeholder="e.g., Men's League 2025">
                            @error('name')
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      placeholder="Brief description of the league...">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="type" id="type" required
                                    ...
                                    <option value="mens" {{ old('type') === 'mens' ? 'selected' : '' }}>Men's League</option>
                                    <option value="womens" {{ old('type') === 'womens' ? 'selected' : '' }}>Women's League</option>
                                    <option value="mixed" {{ old('type') === 'mixed' ? 'selected' : '' }}>Mixed League</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="max_members" id="max_members" min="4" step="2"
                                       value="{{ old('max_members', 40) }}"
                                       class="w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                                       placeholder="40">
                                <p class="mt-1 text-xs text-gray-500">Must be even number for 2-man teams</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="holes" id="holes" required
                                ...
                                <option value="18" {{ old('holes') == 18 ? 'selected' : '' }}>18 Holes</option>
                            </select>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="entry_fee_per_week" id="entry_fee_per_week" min="0" step="0.01"
                                       value="{{ old('entry_fee_per_week', '12.00') }}"
                                       class="w-full pl-7 rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                                       placeholder="12.00">
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="participation_points" id="participation_points" value="1"
                                   {{ old('participation_points') ? 'checked' : '' }}
                        ...
                        <div id="participation_value_wrapper" class="ml-6" style="display: none;">
                            ...
                            <input type="number" name="participation_points_value" id="participation_points_value" min="0"
                                   value="{{ old('participation_points_value', 1) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="weeks_count_for_championship" id="weeks_count_for_championship" min="1"
                                   value="{{ old('weeks_count_for_championship') }}"
                                   class="w-32 rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                                   placeholder="Leave empty to count all weeks">
                            <p class="mt-1 text-xs text-gray-500">Leave empty to count all weeks towards championship</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-4 pt-6 border-t">
                    <a href="{{ route('leagues.index') }}" class="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-lg transition">
                        Cancel
                    </a>
                    <button type="submit" class="px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-md transition">
                        <i class="fas fa-check mr-2"></i>Create League
                    </button>
                </div>
            </form>
        </div>
